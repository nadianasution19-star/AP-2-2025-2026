...
int main(){
    ...
    // cara 1 : array kosong, isi secara manual
    // string nama[5];
    // nama[0] = "Alya";
    // nama[1] = "Parul";
    // nama[2] = "Hana";
    ...
    // string nama[5] = {"Alya", "Pahrul", "Hana", "Dewi", "Padhil"};
    // string nama[] = {"Alya", "Pahrul", "Hana", "Dewi", "Padhil"};
    ...
    // // 3. s1.length(), mengambil panjang string
    // cout << s1.length() << endl;
